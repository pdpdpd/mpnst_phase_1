...
library(VennDiagram, lib.loc = "/camp/lab/vanloop/working/yanh/R/library/")
library(UpSetR, lib.loc = "/camp/lab/vanloop/working/yanh/R/library/")
...
bulk_snv_bulk_normal_dir = paste0("/camp/project/proj-vanloo/analyses/hyan/mpnst/bulk/results/snv_mnv_indel_tumouronly/", bulk_samples, "/", bulk_samples)
scDNA_snv_bulk_normal_dir = paste0("/camp/project/proj-vanloo/analyses/hyan/mpnst/10X_DNA/results/snv_mnv_indel_tumouronly/", samples, "_bulk_normal/")
scDNA_snv_pooled_normal_dir = paste0("/camp/project/proj-vanloo/analyses/hyan/mpnst/10X_DNA/results/snv_mnv_indel_tumouronly/", samples, "_scDNA_normal/")


output.dir = paste0("/camp/project/proj-vanloo/analyses/hyan/mpnst/10X_DNA/results/snv_mnv_indel_tumouronly/SNV_analysis")
...
if (F) {
  ...
  bulk_vcf_files <- paste0("/srv/shared/vanloo/home/hyan/mpnst/bulk/results/snv_mnv_indel_tumouronly/", 
  ...
  # bulk_raw_vcf_files <- paste0("/srv/shared/vanloo/home/hyan/mpnst/bulk/results/snv_mnv_indel_tumouronly/", 
