...
library(tidyverse, lib = "/camp/lab/vanloop/working/yanh/R/library/")
library(xgboost, lib = "/camp/lab/vanloop/working/yanh/R/library/")
library(DiagrammeR, lib = "/camp/lab/vanloop/working/yanh/R/library/")
# library(DiagrammeRsvg, lib = "/camp/lab/vanloop/working/yanh/R/library/")
...
bulk_bam.dir <- paste0("/camp/project/proj-vanloo/analyses/hyan/mpnst/bulk/data/merged_bam/")
scDNA_bam.dir <- paste0("/camp/project/proj-vanloo/analyses/hyan/mpnst/10X_DNA/data/modified_BAMs/", samples, "/")
pooled_bam.dir <- paste0("/camp/project/proj-vanloo/analyses/hyan/mpnst/10X_DNA/data/normal_BAMs/")

snv_analysis.dir = paste0("/camp/project/proj-vanloo/analyses/hyan/mpnst/10X_DNA/results/snv_mnv_indel_tumouronly/SNV_analysis/")

output.dir = paste0("/camp/project/proj-vanloo/analyses/hyan/mpnst/10X_DNA/results/snv_mnv_indel_tumouronly/SNV_filter")
...
if (F) {
  ...
  centromeres <- read_tsv("/camp/project/proj-vanloo/analyses/hyan/ref_files/hg38/centromeres.txt.gz", col_names = F) #many contigs each have their own
